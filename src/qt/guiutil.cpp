...
{
    return GetSpecialFolderPath(CSIDL_STARTUP) / "NexchangeCoin.lnk";
}
...
HelpMessageBox::HelpMessageBox(QWidget *parent) :
    QMessageBox(parent)
{
    header = tr("NexchangeCoin-Qt") + " " + tr("version") + " " +
    ...
    setWindowTitle(tr("NexchangeCoin-Qt"));

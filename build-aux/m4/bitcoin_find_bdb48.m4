AC_DEFUN([NEXCHANGECOIN_FIND_BDB48],[
  ...
  if test "x$bdbpath" = "xX"; then
    ...
    NEXCHANGECOIN_SUBDIR_TO_INCLUDE(BDB_CPPFLAGS,[${bdbpath}],db_cxx)
    ...
    NEXCHANGECOIN_SUBDIR_TO_INCLUDE(BDB_CPPFLAGS,[${bdb48path}],db_cxx)
    bdbpath="${bdb48path}"
  fi

...
{
    return GetSpecialFolderPath(CSIDL_STARTUP) / "CM_CapitalName.lnk";
}
...
bool SetStartOnSystemStartup(bool fAutoStart)
{
    ...
    else
    {
        ...
        optionFile << "Name=CM_CapitalName\n";
...
HelpMessageBox::HelpMessageBox(QWidget *parent) :
    QMessageBox(parent)
{
    header = tr("CM_CapitalName-Qt") + " " + tr("version") + " " +
    ...
    setWindowTitle(tr("CM_CapitalName-Qt"));
